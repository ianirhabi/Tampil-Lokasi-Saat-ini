...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public TextView melihat ;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_maps);
        melihat = (TextView) findViewById(R.id.tampilkan);
    ...
    public void onLocationChanged(Location location) {
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(final LatLng point) {
                ...
                melihat.setText("Posisi Lokasi Anda adalah koordinat : "+latid+" Long : "+longtid);

                // set icon google maps
                mCurrLocationMarker.setIcon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher));
            }
        });
